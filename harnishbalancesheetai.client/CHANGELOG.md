...
- Create Angular project with ng: `ng new harnishbalancesheetai.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`harnishbalancesheetai.client.esproj`).
